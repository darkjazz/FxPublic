...
{
	Patch* p;
	if (patch == 0) { p = [[dw patches] objectForKey: @"horizons"]; }
	else if (patch == 1) { p = [[dw patches] objectForKey: @"axial"]; }
	else if (patch == 2) { p = [[dw patches] objectForKey: @"grid"]; }
	else if (patch == 3) { p = [[dw patches] objectForKey: @"mesh"]; }
